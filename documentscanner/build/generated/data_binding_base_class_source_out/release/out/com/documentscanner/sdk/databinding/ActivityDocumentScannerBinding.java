...
public final class ActivityDocumentScannerBinding implements ViewBinding {
  ...
  private ActivityDocumentScannerBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton captureButton, @NonNull PreviewView previewView) {
  ...
  public static ActivityDocumentScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDocumentScannerBinding((ConstraintLayout) rootView, captureButton,
          previewView);
    }
